#!/usr/bin/env python3
"""
使用huggingface_hub直接下载模型，提供更详细的日志
"""
import os
import time
import sys
...
if __name__ == "__main__":
    ...
    if os.path.exists(local_model_path) and os.listdir(local_model_path):
        ...
        # 下载模型
        result = download_model_hf(model_name, local_model_path)
        if result:
            print("\n模型下载完成！")
